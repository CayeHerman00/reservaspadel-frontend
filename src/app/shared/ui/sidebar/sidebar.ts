...
export class SidebarComponent {
  ...
  readonly courtsRoute = input<string>(APP_ROUTES.courts);
  ...
  private readonly activeNavClass =
    'flex w-full items-center gap-3 bg-[#0052FF] text-white rounded-lg px-4 py-3 shadow-[0_0_20px_rgba(0,82,255,0.3)] font-body font-medium text-sm transition-all active:scale-98';

  private readonly inactiveNavClass =
    'flex w-full items-center gap-3 text-[#c3c5d9] px-4 py-3 hover:bg-[#37393d] hover:translate-x-1 rounded-lg font-body font-medium text-sm transition-all active:scale-98';
